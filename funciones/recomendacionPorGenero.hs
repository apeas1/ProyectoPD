module Funciones.RecomendacionPorGenero(
...
showRecomendadosGenero :: IO ()
showRecomendadosGenero = do
    let lista = recPorGenero usuarios canciones
    let n = length lista
...
showusersauxGenero n c lista = do
    if c == n then do
        ...
        putStrLn ""
        let listacanciones = (lista !! c)
        print(listacanciones)  
        putStrLn ""
        showusersauxGenero n (c+1) lista
...
us1 = User 1 "Jaime" [s189,s200, s190, s191, s195] [a, b, c, d] [al1]
us2 = User 2 "Pedro" [s190,s191, s192, s193] [a, b] [al1]
us3 = User 3 "Helena" [s193, s194, s195, s196, s200, s201] [a] [al2]
us4 = User 4 "Sandra" [s199, s197, s198, s202] [b] [al2]
us5 = User 5 "Maria" [s203, s189, s199, s204, s205, s195] [] []
us6 = User 6 "Juan" [s195,s205, s199, s196, s197] [c] [al1, al2]
us7 = User 7 "Manuel" [s198, s199, s200, s201, s197] [c, d] [al2]
us8 = User 8 "Marta" [s200, s201, s202, s197, s198, s199, s200] [c, d] [al1, al2]
us9 = User 9 "Esteban" [s190, s192, s194, s196, s198, s200, s202, s204] [d] []
